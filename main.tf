...
resource "aws_cloudfront_response_headers_policy" "this" {
  ...
  name    = "${local.name_prefix}-response-headers"
  comment = "Response headers policy for ${local.name_prefix}"
...
resource "aws_cloudfront_function" "this" {
  ...
  comment = "Viewer request handler for ${local.name_prefix}"
  publish = true
...
resource "aws_cloudfront_distribution" "this" {
  ...
  comment             = "CDN distribution for ${local.name_prefix}"
